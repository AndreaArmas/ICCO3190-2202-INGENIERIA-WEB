...
import sessionBeans.NominaFacade;
...
public class NominaController implements Serializable {
    ...
    private Nomina current;
    private DataModel items = null;
    @EJB
    private sessionBeans.NominaFacade ejbFacade;
    ...
    public String prepareView() {
        current = (Nomina) getItems().getRowData();
    ...
    public String create() {
        try {
            float sueldo=(current.getHoras_trabajadas()*current.getValorHoraTrabajo())-current.getValorMulta();
            current.setSueldoTotal(sueldo);
            getFacade().create(current);
            JsfUtil.addSuccessMessage(ResourceBundle.getBundle("/Bundle").getString("NominaCreated"));
    ...
    public String update() {
        try {
            ...
            JsfUtil.addSuccessMessage(ResourceBundle.getBundle("/Bundle").getString("NominaUpdated"));
            return "View";
        } catch (Exception e) {
            JsfUtil.addErrorMessage(e, ResourceBundle.getBundle("/Bundle").getString("PersistenceErrorOccured"));
            return null;
    ...
    private void performDestroy() {
        try {
            ...
            JsfUtil.addSuccessMessage(ResourceBundle.getBundle("/Bundle").getString("NominaDeleted"));
        } catch (Exception e) {
            JsfUtil.addErrorMessage(e, ResourceBundle.getBundle("/Bundle").getString("PersistenceErrorOccured"));
        }
    }
